...
const payer = Keypair.fromSecretKey(new Uint8Array(JSON.parse(fs.readFileSync(`C:/Users/com/.config/solana/id.json`, "utf-8")))); // This will be the account paying for the transaction
...
// to run this code first need to get a local wallet
// then set the network to devnet
// then airdrop 1 sol
// then run this code, after running this code you will get to see that there is some solana get cut 